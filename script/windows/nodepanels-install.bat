...
powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('https://nodepanels-file-1256221051.cos.accelerate.myqcloud.com/probe/windows/nodepanels-probe.exe', '%USERPROFILE%\nodepanels\nodepanels-probe.exe')"
if errorlevel 1 (
...
powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('https://nodepanels-file-1256221051.cos.accelerate.myqcloud.com/probe/windows/nodepanels-daemon.exe', '%USERPROFILE%\nodepanels\nodepanels-daemon.exe')"
if errorlevel 1 (
